...
public class AesCipher {
	...
	/**
	 * @see <a href=
	 *      "https://stackoverflow.com/questions/9655181/how-to-convert-a-byte-array-to-a-hex-string-in-java">how-to-convert-a-byte-array-to-a-hex-string</a>
	 */
	...
	public static AesCipher encrypt(String secretKey, String plainText) {
		...
		try {
			...
			String result = Base64.getUrlEncoder().encodeToString(byteBuffer.array());
